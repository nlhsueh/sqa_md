...
FIG: 強固邊界測試
<img src="img/blackbox/boundary_robust.png" width="500">
...
- 一個 junit 測試方法內一個觀念或是一個 assert (single assert in single test)；
- junit 內的測試方法沒有順序；
...
透過上述的決策表我們發現有些地方是無法確定的（打X的部份），因此分割需要再細一些，怎麼做呢？大家嘗試看看吧！
